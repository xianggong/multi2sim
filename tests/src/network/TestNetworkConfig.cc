...
TEST(TestSystemConfiguration, section_network_two_defaults_missing) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: test:\nDefault values can not be"
                               " zero/non-existent.\n.*",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_node_unknown_fixlatency) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Network test cannot have a negative "
                               "fix latency",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_node_unknown_type) {
  ...
  EXPECT_TRUE(system->getNetworkByName("test") != nullptr);
  EXPECT_REGEX_MATCH(misc::fmt("%s: Node type 'anything' is not "
                               "supported.\n.*",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_node_no_preset_net) {
  ...
  EXPECT_TRUE(system->getNetworkByName("test") == nullptr);
  EXPECT_REGEX_MATCH(misc::fmt("%s: Section (.Network\\.test\\.Node\\.N1.), "
...
TEST(TestSystemConfiguration, section_node_buffer_size_vs_msg_size) {
  ...
  EXPECT_TRUE(system->getNetworkByName("test") != nullptr);
  EXPECT_REGEX_MATCH(misc::fmt("%s: Invalid argument for Node 'N1'\n.*",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
}
...
TEST(TestSystemConfiguration, section_node_switch_bandwidth) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Invalid argument for Node 'S1'\n.*",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
}
...
TEST(TestSystemConfiguration, section_link_type) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Link type 'anything' is not supported.\n.*",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
}
...
TEST(TestSystemConfiguration, section_link_wrong_source) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Source node 'anything' is invalid"
                               " for link 'S1-S2'.\n",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_link_no_source) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Source node is not provided "
                               "for link 'S1-S2'.\n",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_link_wrong_destination) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Destination node 'anything' is "
...
TEST(TestSystemConfiguration, section_link_no_destination) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Destination node is not provided "
                               "for link 'S1-S2'.\n",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_link_same_src_dst) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Link 'S1-S2', source "
...
TEST(TestSystemConfiguration, section_link_bandwidth) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Link 'S1-S2', bandwidth cannot "
                               "be zero/negative.\n",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_link_between_end_nodes) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("Network 'test': Link 'S1-S2' cannot connect "
                               "two end-nodes.")
                         .c_str(),
                     message.c_str());
}
...
TEST(TestSystemConfiguration, section_bus_unknown_varialbe) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Section (.Network\\.test\\.Bus\\.B0.), "
...
TEST(TestSystemConfiguration, section_bus_negative_bandwdith) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Bus 'B0', bandwidth cannot be "
                               "zero/negative.\n",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_bus_negative_lanes) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Bus 'B0', number of lanes cannot be "
                               "zero/negative.\n",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_busport_no_bus) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Bus name should be included for "
                               "the port.",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, section_busport_wrong_bus) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Bus 'B0' does not exist in "
                               "the network.",
                               ini_file.getPath().c_str())
                         .c_str(),
                     message.c_str());
...
TEST(TestSystemConfiguration, routes_wrong_source_node) {
  ...
  EXPECT_REGEX_MATCH(misc::fmt("%s: Section (.Network\\.test\\.Routes.), "
