...
TEST(TestX86TimingFetchStage, pipeline_flush) {
  ...
  try {
    ...
    std::cerr << "Exception in reading x86 configuration" << e.getMessage()
              << "\n";
    ASSERT_TRUE(false);
  }
  ...
  try {
    ...
    std::cerr << "Exception in reading mem configuration" << e.getMessage()
              << "\n";
    ASSERT_TRUE(false);
  }
  ...
  // mov eax, 1
  // int 0x80
  unsigned char code[] = {0xB8, 0x01, 0x00, 0x00, 0x00, 0xCD, 0x80};
  ...
  // number
  int expected_fetch_queue_size[] = {2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
                                     2, 2, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  int expected_fetch_queue_occupency[] = {7, 7, 7, 7, 7, 7, 7, 7, 7, 7,
                                          7, 7, 0, 0, 0, 0, 0, 0, 0, 0};
...
TEST(TestX86TimingFetchStage, fetch_same_block) {
  ...
  // the code.
  unsigned char code[] = {
      0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8,
      0x89, 0xD8, 0x89, 0xD8, 0xEB, 0xF0, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8,
      0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8,
      0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8,
      0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8,
      0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8, 0x89, 0xD8,
  ...
  // The expected number of uops in the fetch queue, indexed by cycle
  // number
  int expected_fetch_queue_size[] = {32, 32, 32, 32, 32, 32, 32, 32, 32, 32,
  ...
  int expected_fetch_queue_occupency[] = {
      ...
      64, 64, 0,  0,  0,  0,  0,  0,  0,  16, 32, 48, 64, 64, 64};
