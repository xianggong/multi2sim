...
TEST(TestSystemEvents, config_0_evict_0) {
  try {
    ...
    // Set block states
    module_l1_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockModified,
                                                         0x0);
    module_l1_1->getCache()->getBlock(1, 0)->setStateTag(Cache::BlockModified,
                                                         0x40);
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
    ...
    while (witness < 0) esim_engine->ProcessEvents();
...
TEST(TestSystemEvents, config_0_evict_1) {
  try {
    ...
    // Set block states
    module_l1_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_l1_1->getCache()->getBlock(1, 0)->setStateTag(Cache::BlockModified,
                                                         0x40);
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
...
TEST(TestSystemEvents, config_0_evict_2) {
  try {
    ...
    // Set block states
    module_l1_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockOwned,
                                                         0x0);
    module_l1_1->getCache()->getBlock(1, 0)->setStateTag(Cache::BlockModified,
                                                         0x40);
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
...
TEST(TestSystemEvents, config_0_evict_3) {
  try {
    ...
    // Set block states
    module_l1_0->getCache()->getBlock(0, 0)->setStateTag(
        Cache::BlockNonCoherent, 0x0);
    module_l1_1->getCache()->getBlock(1, 0)->setStateTag(Cache::BlockModified,
                                                         0x40);
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
...
TEST(TestSystemEvents, config_0_evict_4) {
  try {
    ...
    // Set block states
    module_l1_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l1_1->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
...
TEST(TestSystemEvents, config_0_evict_5) {
  try {
    ...
    module_l1_1->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
    module_l2_0->setOwner(0, 0, 0, nullptr);
...
TEST(TestSystemEvents, config_0_evict_7) {
  try {
    ...
    module_l1_1->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(
        Cache::BlockNonCoherent, 0x0);
    module_mm->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
    module_l2_0->setOwner(0, 0, 0, nullptr);
...
TEST(TestSystemEvents, config_0_load_0) {
  try {
    ...
    // Set block states
    module_l1_0->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_l1_1->getCache()->getBlock(1, 1)->setStateTag(Cache::BlockModified,
                                                         0x40);
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 7)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
...
TEST(TestSystemEvents, config_0_load_2) {
  try {
    ...
    // Set block states
    module_l1_0->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockModified,
                                                         0x0);
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 7)->setStateTag(Cache::BlockExclusive,
...
TEST(TestSystemEvents, config_0_load_4) {
  try {
    ...
    // Set block states
    module_mm->getCache()->getBlock(0, 7)->setStateTag(Cache::BlockModified,
                                                       0x0);
...
TEST(TestSystemEvents, config_0_load_5) {
  try {
    ...
    // Set block states
    module_l1_1->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockModified,
                                                         0x0);
    module_l1_1->getCache()->getBlock(1, 1)->setStateTag(Cache::BlockModified,
                                                         0x40);
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockExclusive,
...
TEST(TestSystemEvents, config_0_load_8) {
  try {
    ...
    // Set Block States
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockOwned,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 7)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
    module_mm->setOwner(0, 7, 0, module_l2_0);
...
TEST(TestSystemEvents, config_0_load_9) {
  try {
    ...
    // Set Block States
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 7)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
    module_mm->setSharer(0, 7, 0, module_l2_0);
...
TEST(TestSystemEvents, config_0_ncstore_1) {
  try {
    ...
    // Set Block States
    module_l1_0->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l1_1->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 7)->setStateTag(Cache::BlockExclusive,
...
TEST(TestSystemEvents, config_0_ncstore_3) {
  try {
    ...
    // Set Block States
    module_l1_3->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_l2_1->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_l2_1->setSharer(0, 3, 0, module_l1_3);
    module_l2_1->setOwner(0, 3, 0, module_l1_3);
    module_mm->getCache()->getBlock(0, 15)->setStateTag(Cache::BlockExclusive,
                                                        0x0);
...
TEST(TestSystemEvents, config_0_ncstore_4) {
  try {
    ...
    // Set Block States
    module_l1_0->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockOwned,
                                                         0x0);
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_mm->getCache()->getBlock(0, 7)->setStateTag(Cache::BlockExclusive,
...
TEST(TestSystemEvents, config_0_store_2) {
  try {
    ...
    module_l1_0->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l1_2->getCache()->getBlock(0, 1)->setStateTag(Cache::BlockShared,
                                                         0x0);

    // Set L2 Block States and sharer/owner
    module_l2_0->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l2_1->getCache()->getBlock(0, 3)->setStateTag(Cache::BlockShared,
                                                         0x0);
    module_l2_0->setSharer(0, 3, 0, module_l1_0);
...
TEST(TestSystemEvents, config_1_evict_0) {
  try {
    ...
    module_l2_0->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                         0x0);
    module_l3->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
    module_mm->getCache()->getBlock(0, 0)->setStateTag(Cache::BlockExclusive,
                                                       0x0);
    module_l2_0->setOwner(0, 0, 0, module_l1_0);
