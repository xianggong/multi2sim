...
/* Remove spaces from the beginning and end of string 'src'. The resulting
 * string
 * is placed in buffer 'dest' with a maximum capacity of 'size' bytes. The
 * resulting
 ...
 * If conversion fails due to wrong formatting of 'str', an error code is
 * returned
