...
struct opencl_object_t* opencl_object_find(void* object,
                                           enum opencl_object_type_t type);

int opencl_object_verify(void* object, enum opencl_object_type_t type);

int opencl_object_ref_update(void* object, enum opencl_object_type_t type,
                             int change);
int opencl_object_retain(void* object, enum opencl_object_type_t type,
                         int err_code);
int opencl_object_release(void* object, enum opencl_object_type_t type,
                          int err_code);
