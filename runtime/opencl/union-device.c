...
struct opencl_union_device_t *opencl_union_device_create(
    struct opencl_device_t *parent, struct list_t *devices) {
  cl_uint i;
  ...
  *(parent) = *(struct opencl_device_t *)list_get(devices, 0);
  ...
  parent->arch_device_free_func =
      (opencl_arch_device_free_func_t)opencl_union_device_free;
  ...
  parent->arch_program_create_func =
      (opencl_arch_program_create_func_t)opencl_union_program_create;
  parent->arch_program_free_func =
      (opencl_arch_program_free_func_t)opencl_union_program_free;
  ...
  parent->arch_kernel_create_func =
      (opencl_arch_kernel_create_func_t)opencl_union_kernel_create;
  parent->arch_kernel_free_func =
      (opencl_arch_kernel_free_func_t)opencl_union_kernel_free;
  parent->arch_kernel_set_arg_func =
      (opencl_arch_kernel_set_arg_func_t)opencl_union_kernel_set_arg;

  /* Call-back functions for architecture-specific ND-Range */
  parent->arch_ndrange_create_func =
      (opencl_arch_ndrange_create_func_t)opencl_union_ndrange_create;
  parent->arch_ndrange_finish_func =
      (opencl_arch_ndrange_finish_func_t)opencl_union_ndrange_finish;
  parent->arch_ndrange_free_func =
      (opencl_arch_ndrange_free_func_t)opencl_union_ndrange_free;
  parent->arch_ndrange_init_func =
      (opencl_arch_ndrange_init_func_t)opencl_union_ndrange_init;
  parent->arch_ndrange_run_func =
      (opencl_arch_ndrange_run_func_t)opencl_union_ndrange_run;
  parent->arch_ndrange_run_partial_func =
      (opencl_arch_ndrange_run_partial_func_t)opencl_union_ndrange_run_partial;
