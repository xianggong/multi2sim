...
class Runtime {
 ...
 public:
  ...
  ///
  Runtime(const std::string& name, const std::string& library_name,
  ...
  void setOpenAttempt(bool open_attempt) { this->open_attempt = open_attempt; }
};
...
class RuntimePool {
 ...
 public:
  ...
  void Register(const std::string& name, const std::string& library_name,
                const std::string& redirect_library_name);
