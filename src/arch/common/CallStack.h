...
class CallStackMap {
 ...
 public:
  /// Constructor
  CallStackMap(const std::string& path, unsigned offset, unsigned address,
               unsigned size, bool dynamic)
      : path(path),
        offset(offset),
        address(address),
        size(size),
...
class CallStackFrame {
 ...
 public:
  CallStackFrame(unsigned ip, unsigned sp) : ip(ip), sp(sp) {}
...
class CallStack {
 ...
 public:
  ...
  void Map(const std::string& path, unsigned offset, unsigned address,
           unsigned size, bool dynamic);
