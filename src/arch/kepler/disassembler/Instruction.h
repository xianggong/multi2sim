...
#define DEFINST(_name, _fmt_str, ...) INST_##_name,
...
#undef DEFINST
  ...
  /// Need to figure out how to re-label constant once I know what this field
  /// represents
  /// MOV32I
 ...
 private:
  ...
  void DumpUs(std::ostream& os, int high0, int low0, int high1, int low1) const;
