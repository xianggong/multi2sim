...
enum BinaryUserData {
  ...
  BinaryUserDataGDSCounterRange,  // immediate UINT with GDS address range for
                                  // counters
  BinaryUserDataGDSMemoryRange,   // immediate UINT with GDS address range for
                                  // storage
  ...
  BinaryUserDataInteralResourceTable,  // flat/chunked internal resource table
                                       // pointer
  ...
  BinaryUserDataInternalResource,  // pointer to internal resource indirection
                                   // table
