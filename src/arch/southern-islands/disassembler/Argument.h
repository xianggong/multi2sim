...
class Argument {
 public:
  /// Argument type
  enum Type { TypeInvalid = 0, TypeValue, TypePointer, TypeImage, TypeSampler };
 ...
 public:
  /// Constructor
  Argument(Type type, const std::string& name) : type(type), name(name) {}
...
class PointerArgument : public Argument {
 ...
 public:
  PointerArgument(const std::string& name, DataType data_type, int num_elems,
                  int constant_buffer_num, int constant_offset, Scope scope,
                  int buffer_num, int alignment, AccessType access_type)
  ...
  void setDevicePtr(unsigned int device_ptr) { this->device_ptr = device_ptr; }
  ...
  void setConstantBufferNum(int constant_buffer_num) {
    this->constant_buffer_num = constant_buffer_num;
  }

  /// Set the constant offset
  void setConstantOffset(int constant_offset) {
    this->constant_offset = constant_offset;
  }
...
class ValueArgument : public Argument {
 ...
 public:
  ValueArgument(const std::string& name, DataType data_type, int num_elems,
...
class ImageArgument : public Argument {
 ...
 public:
  ImageArgument(const std::string& name, int dimension, AccessType access_type,
                int uav, int constant_buffer_num, int constant_offset)
...
class SamplerArgument : public Argument {
 ...
 public:
  SamplerArgument(const std::string& name, int id, unsigned int location,
                  int value)
      : Argument(TypeSampler, name), id(id), location(location), value(value) {}
