...
class Wavefront {
 ...
 public:
  ...
  WorkItem* getScalarWorkItem() const { return scalar_work_item.get(); }
  ...
  /// barrier instruction
  void setBarrierInstruction(bool barrier_instruction) {
    this->barrier_instruction = barrier_instruction;
  }
  ...
  void setSRegWithConstantBuffer(int first_reg, int num_regs, int cb);
