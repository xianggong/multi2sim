...
void WorkItem::ISA_S_LOAD_DWORDX2_Impl(Instruction *instruction) {
  ...
  // Debug
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("S[%u,%u] <= (addr %u): ", INST.sdst,
                                     INST.sdst + 3, m_addr);
    for (int i = 0; i < 2; i++) {
...
// This instruction uses a 32-bit literal constant. Write some or all of the
// LSBs of IMM32 into a hardware register.
  ...
  if (execz.as_uint) {
    ...
    if (Emulator::isa_debug) {
      Emulator::isa_debug << misc::fmt(
          ...
          "(not taken)",
          wavefront->getId(), exec.as_uint, execz.as_uint);
    }
  }
}
#undef INST
...
void WorkItem::ISA_S_BARRIER_Impl(Instruction *instruction) {
  ...
  if (work_group->getWavefrontsAtBarrier() ==
      work_group->getWavefrontsInWorkgroup()) {
...
void WorkItem::ISA_V_CVT_F64_I32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V[%u:+1]<=(%lgf) ", id, INST.vdst,
                                     value.as_double);
  }
}
#undef INST
...
void WorkItem::ISA_V_CVT_U32_F32_Impl(Instruction *instruction) {
  ...
  // inf, > max_uint --> max_uint
           ...
           fvalue >= std::numeric_limits<unsigned int>::max())
...
void WorkItem::ISA_V_CVT_I32_F32_Impl(Instruction *instruction) {
  ...
  // inf, > max_int --> max_int
  if ((std::isinf(fvalue) && fvalue > 0.0f) ||
...
void WorkItem::ISA_V_MOVRELD_B32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V[%u+%u]<=(0x%x) ", id, INST.vdst,
                                     m0.as_uint, s0.as_uint);
  }
}
#undef INST
...
void WorkItem::ISA_V_MUL_LEGACY_F32_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%gf) (%gf * %gf) ", id,
                                     INST.vdst, product.as_float, s0.as_float,
                                     s1.as_float);
  }
}
#undef INST
...
void WorkItem::ISA_V_MUL_F32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%gf) (%gf*%gf)", id, INST.vdst,
                                     product.as_float, s0.as_float,
                                     s1.as_float);
  }
}
#undef INST
...
void WorkItem::ISA_V_LSHRREV_B32_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%u) (%u >> %u) ", id,
                                     INST.vdst, result.as_uint, s1.as_uint,
                                     s0.as_uint);
  }
}
#undef INST
...
void WorkItem::ISA_V_AND_B32_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(0x%x) (%u & %u) ", id,
                                     INST.vdst, result.as_uint, s0.as_uint,
                                     s1.as_uint);
  }
}
#undef INST
...
void WorkItem::ISA_V_XOR_B32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%u)(%u ^ %u) ", id, INST.vdst,
                                     result.as_uint, s0.as_uint, s1.as_uint);
  }
}
#undef INST
...
void WorkItem::ISA_V_ADD_I32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%d) (%d + %d) ", id, INST.vdst,
                                     sum.as_int, s0.as_int, s1.as_int);
...
void WorkItem::ISA_V_CNDMASK_B32_VOP3a_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%u, %gf) (s1=%u, s0=%u)", id,
                                     INST.vdst, result.as_uint, result.as_float,
                                     s1.as_uint, s0.as_uint);
  }
}
#undef INST
...
void WorkItem::ISA_V_BFE_U32_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt(
        "t%d: value:s0:%u, offset:s1:%u, width:s2:%u ", id, s0.as_uint,
        s1.as_uint, s2.as_uint);
...
void WorkItem::ISA_V_FMA_F32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%gf) (%gf*%gf + %gf) ", id,
                                     INST.vdst, result.as_float, s0.as_float,
                                     s1.as_float, s2.as_float);
  }
}
#undef INST
...
void WorkItem::ISA_V_FMA_F64_Impl(Instruction *instruction) {
  ...
  s2.as_reg[0] = ReadReg(INST.src2);
  s2.as_reg[1] = ReadReg(INST.src2 + 1);

  // Apply absolute value modifiers.
  if (INST.abs & 1) s0.as_double = fabsf(s0.as_double);
  if (INST.abs & 2) s1.as_double = fabsf(s1.as_double);
  if (INST.abs & 4) s2.as_double = fabsf(s2.as_double);

  // Apply negation modifiers.
  if (INST.neg & 1) s0.as_double = -s0.as_double;
  if (INST.neg & 2) s1.as_double = -s1.as_double;
  if (INST.neg & 4) s2.as_double = -s2.as_double;
...
void WorkItem::ISA_V_ALIGNBIT_B32_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt(
        "t%d: V%u<=(0x%x, %u) ({0x%x,0x%x} >> %u) ", id, INST.vdst,
        result.as_uint, result.as_uint, src.as_reg[1], src.as_reg[0],
        src2.as_uint);
  }
}
#undef INST
...
void WorkItem::ISA_V_MUL_HI_U32_Impl(Instruction *instruction) {
  ...
  result.as_uint = (unsigned)(((unsigned long long)s0.as_uint *
...
void WorkItem::ISA_V_CMP_LT_F32_VOP3a_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: S[%u:+1]<=(%u) ", id_in_wavefront,
...
void WorkItem::ISA_V_CMP_GT_I32_VOP3a_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: S[%u:%u]<=(%u) ", id_in_wavefront,
...
void WorkItem::ISA_V_MAX3_I32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V[%u]<=(%d) ", id_in_wavefront,
                                     INST.vdst, max.as_int);
  }
}
#undef INST
...
void WorkItem::ISA_V_LSHR_B64_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: S[%u]<=(0x%x) ", id_in_wavefront,
...
void WorkItem::ISA_V_INTERP_P1_F32_Impl(Instruction *instruction) {
  ...
  lds->Read(m0_vintrp.for_vintrp.lds_param_offset + 0 + 4 * INST.attrchan, 4,
            (char *)&p0.as_uint);
  // 4dwords P10: X Y Z W, INST.attrchan decides which 1dword to be loaded
  lds->Read(m0_vintrp.for_vintrp.lds_param_offset + 16 + 4 * INST.attrchan, 4,
            (char *)&p10.as_uint);
...
void WorkItem::ISA_V_INTERP_P2_F32_Impl(Instruction *instruction) {
  ...
  lds->Read(m0_vintrp.for_vintrp.lds_param_offset + 32 + 4 * INST.attrchan, 4,
            (char *)&p20.as_uint);
...
void WorkItem::ISA_DS_WRITE2_B32_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug && INST.gds) {
    Emulator::isa_debug << misc::fmt("t%d: GDS[%u]<=(%u,%f) ", id,
                                     addr0.as_uint, data0.as_uint,
                                     data0.as_float);
    Emulator::isa_debug << misc::fmt("GDS[%u]<=(%u,%f) ", addr1.as_uint,
                                     data0.as_uint, data0.as_float);
  } else {
    Emulator::isa_debug << misc::fmt("t%d: LDS[%u]<=(%u,%f) ", id,
                                     addr0.as_uint, data0.as_uint,
                                     data0.as_float);
    Emulator::isa_debug << misc::fmt("LDS[%u]<=(%u,%f) ", addr1.as_uint,
                                     data1.as_uint, data1.as_float);
  }
}
#undef INST
...
void WorkItem::ISA_DS_WRITE_B32_Impl(Instruction *instruction) {
  ...
  // Print isa debug information.
  if (Emulator::isa_debug && INST.gds) {
    Emulator::isa_debug << misc::fmt("t%d: GDS[%u]<=(%u,%f) ", id, addr.as_uint,
                                     data0.as_uint, data0.as_float);
  } else {
    Emulator::isa_debug << misc::fmt("t%d: LDS[%u]<=(%u,%f) ", id, addr.as_uint,
                                     data0.as_uint, data0.as_float);
  }
}
#undef INST
...
void WorkItem::ISA_DS_WRITE_B8_Impl(Instruction *instruction) {
  ...
  if (INST.gds) {
    ...
    lds->Write(addr.as_uint, 1, (char *)data0.as_ubyte);
  }
  ...
  // Print isa debug information.
  if (Emulator::isa_debug && INST.gds) {
    Emulator::isa_debug << misc::fmt("t%d: GDS[%u]<=(0x%x) ", id, addr.as_uint,
                                     data0.as_ubyte[0]);
  } else {
    Emulator::isa_debug << misc::fmt("t%d: LDS[%u]<=(0x%x) ", id, addr.as_uint,
                                     data0.as_ubyte[0]);
  }
}
#undef INST
...
void WorkItem::ISA_DS_WRITE_B16_Impl(Instruction *instruction) {
  ...
  if (INST.gds) {
    ...
    lds->Write(addr.as_uint, 2, (char *)data0.as_ushort);
  }
...
#define INST INST_DS
void WorkItem::ISA_DS_ADD_RTN_U32_Impl(Instruction *instruction) {
  ISAUnimplemented(instruction);
}
#undef INST
...
void WorkItem::ISA_DS_READ_B32_Impl(Instruction *instruction) {
  ...
  if (INST.gds) {
    ...
    lds->Read(addr.as_uint, 4, (char *)&data.as_uint);
  }
  ...
  // Print isa debug information.
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(0x%x)(0x%x) ", id, INST.vdst,
...
void WorkItem::ISA_DS_READ2_B32_Impl(Instruction *instruction) {
  ...
  if (INST.gds) {
    ...
    lds->Read(addr.as_uint + INST.offset0 * 4, 4, (char *)&data0.as_uint);
    lds->Read(addr.as_uint + INST.offset1 * 4, 4, (char *)&data1.as_uint);
  }
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(0x%x)(0x%x) ", id, INST.vdst,
                                     addr.as_uint + INST.offset0 * 4,
                                     data0.as_uint);
    Emulator::isa_debug << misc::fmt("V%u<=(0x%x)(0x%x) ", INST.vdst + 1,
                                     addr.as_uint + INST.offset1 * 4,
                                     data1.as_uint);
  }
}
#undef INST
...
void WorkItem::ISA_DS_READ_I8_Impl(Instruction *instruction) {
  ...
  if (INST.gds) {
    ...
    lds->Read(addr.as_uint, 1, &data.as_byte[0]);
  }
...
void WorkItem::ISA_DS_READ_U8_Impl(Instruction *instruction) {
  ...
  if (INST.gds) {
    ...
    lds->Read(addr.as_uint, 1, (char *)&data.as_ubyte[0]);
  }
...
void WorkItem::ISA_DS_READ_U16_Impl(Instruction *instruction) {
  ...
  if (INST.gds) {
    ...
    lds->Read(addr.as_uint, 2, (char *)&data.as_ushort[0]);
  }
...
#define INST INST_MUBUF
void WorkItem::ISA_BUFFER_LOAD_USHORT_Impl(Instruction *instruction) {
  assert(!INST.addr64);
  assert(!INST.glc);
  assert(!INST.slc);
  assert(!INST.tfe);
...
#define INST INST_MUBUF
void WorkItem::ISA_BUFFER_LOAD_SSHORT_Impl(Instruction *instruction) {
  assert(!INST.addr64);
  assert(!INST.glc);
  assert(!INST.slc);
  assert(!INST.tfe);
...
void WorkItem::ISA_BUFFER_STORE_DWORD_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: (%u)<=V%u(%d) ", id, addr,
                                     INST.vdata, value.as_int);
  }
}
#undef INST

// Store VDATA dword into SRSRC resource. If GLC flag is set then return
// previous value from resource to VDATA, otherwise keep VDATA value. Operation
// is atomic.
#define INST INST_MUBUF
void WorkItem::ISA_BUFFER_ATOMIC_SWAP_Impl(Instruction *instruction) {
  ISAUnimplemented(instruction);
}
#undef INST
...
void WorkItem::ISA_TBUFFER_LOAD_FORMAT_X_Impl(Instruction *instruction) {
  ...
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: V%u<=(%u)(%u,%gf) ", id, INST.vdata,
                                     addr, value.as_uint, value.as_float);
    if (INST.offen) Emulator::isa_debug << misc::fmt("offen ");
    if (INST.idxen) Emulator::isa_debug << misc::fmt("idxen ");
...
void WorkItem::ISA_TBUFFER_STORE_FORMAT_X_Impl(Instruction *instruction) {
  ...
  // TODO Print value based on type
  if (Emulator::isa_debug) {
    Emulator::isa_debug << misc::fmt("t%d: (%u)<=V%u(%u,%gf) ", id, addr,
