...
public:
	...
	/// Get relative 2nd PC if binary contains 2 versions of kernels.
	/// Our experimental compiler can pack instructions generated by 2 different
	/// instruction scheduling algorithms. The 2 sets of instructions are 
	/// concatenated within a kernel function. We'll use different initial PC to
	/// execute the same kernel with different orders for workgroups.
