...
#define __UNIMPLEMENTED__ \
  throw misc::Panic(      \
      misc::fmt("Unimplemented driver function %s\n", __FUNCTION__));
...
int Driver::CallInit(comm::Context* context, mem::Memory* memory,
  ...
  debug << misc::fmt(
      "Finished executing driver function %s, "
      "returning %d.\n",
      __FUNCTION__, 0);
...
int Driver::CallShutDown(comm::Context* context, mem::Memory* memory,
                         unsigned args_ptr) {
  debug << misc::fmt("Executing driver function %s.\n", __FUNCTION__);
  debug << misc::fmt(
      "Finished executing driver function %s, "
...
int Driver::CallSystemGetInfo(comm::Context* context, mem::Memory* memory,
                              unsigned args_ptr) {
  ...
  switch (data.attribute) {
    ...
    default:
      ...
      throw misc::Panic(
          misc::fmt("Unsupported attribute %d in "
                    "get_system_info",
                    data.attribute));
      return 0;
  }
...
int Driver::CallIterateAgents(comm::Context* context, mem::Memory* memory,
                              unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 1;
}

int Driver::CallAgentGetInfo(comm::Context* context, mem::Memory* memory,
                             unsigned args_ptr) {
  struct __attribute__((packed)) {
    uint32_t status;
    uint64_t agent;
  ...
  Component* component = Emulator::getInstance()->getComponent(data.agent);
  ...
  switch (data.attribute) {
    ...
    case HSA_AGENT_INFO_FEATURE:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_FEATURE\n");
      break;
    ...
    case HSA_AGENT_INFO_PROFILE:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_PROFILE\n");
      break;

    case HSA_AGENT_INFO_DEFAULT_FLOAT_ROUNDING_MODE:

      throw misc::Panic(
          "Unsupported agent_get_info attribute "
    ...
    case HSA_AGENT_INFO_BASE_PROFILE_DEFAULT_FLOAT_ROUNDING_MODES:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute "
          "HSA_AGENT_INFO_BASE_PROFILE_DEFAULT_FLOAT_ROUNDING_"
          "MODES\n");
      break;
    ...
    case HSA_AGENT_INFO_WORKGROUP_MAX_DIM:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_WORKGROUP_MAX_DIM\n");
      break;
    ...
    case HSA_AGENT_INFO_GRID_MAX_DIM:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_GRID_MAX_DIM\n");
      break;
    ...
    case HSA_AGENT_INFO_QUEUES_MAX:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_QUEUES_MAX\n");
      break;
    ...
    case HSA_AGENT_INFO_QUEUE_TYPE:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_QUEUE_TYPE\n");
      break;

    case HSA_AGENT_INFO_NODE:

      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_NODE\n");
      break;
    ...
    case HSA_AGENT_INFO_CACHE_SIZE:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_CACHE_SIZE\n");
      break;
    ...
    case HSA_AGENT_INFO_EXTENSIONS:
      ...
      throw misc::Panic(
          "Unsupported agent_get_info attribute HSA_AGENT_INFO_EXTENSIONS\n");
      break;
...
int Driver::CallQueueCreate(comm::Context* context, mem::Memory* memory,
                            unsigned args_ptr) {
  struct __attribute__((packed)) {
    uint32_t status;
    uint64_t agent;
...
int Driver::CallQueueDestroy(comm::Context* context, mem::Memory* memory,
                             unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallQueueInactivate(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}
...
int Driver::CallQueueStoreWriteIndexRelaxed(comm::Context* context,
  ...
  unsigned long long queue_ptr =
      getArgumentValue<unsigned long long>(0, memory, args_ptr);
  unsigned long long value =
      getArgumentValue<unsigned long long>(8, memory, args_ptr);
...
int Driver::CallQueueAddWriteIndexAcqRel(comm::Context* context,
  ...
  // Retrieve the read index
  unsigned long long* write_index = (unsigned long long*)memory->getBuffer(
      queue_ptr + 40, 8, mem::Memory::AccessWrite);

  // Write write index back to argument
  this->setArgumentValue<unsigned long long>(*write_index, 0, memory, args_ptr);
...
int Driver::CallAgentIterateRegions(comm::Context* context, mem::Memory* memory,
                                    unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallRegionGetInfo(comm::Context* context, mem::Memory* memory,
                              unsigned args_ptr) {
  // Arguments		| Offset	| Size
  // hsa_status_t		| 0		| 4
  // region		| 4		| 8
  ...
  unsigned int attribute = getArgumentValue<unsigned int>(12, memory, args_ptr);
  ...
  switch (attribute) {
    ...
    default:
      ...
      throw misc::Panic(
          misc::fmt("Unsupported region info attribute "
                    "%d",
                    attribute));
  }
...
int Driver::CallMemoryRegister(comm::Context* context, mem::Memory* memory,
                               unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallMemoryDeregister(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallMemoryAllocate(comm::Context* context, mem::Memory* memory,
                               unsigned args_ptr) {
  // Arguments		| Offset	| Size
  // hsa_status_t		| 0		| 4
  // region		| 4		| 8
  ...
  unsigned long long ptr =
      getArgumentValue<unsigned long long>(20, memory, args_ptr);
...
int Driver::CallMemoryFree(comm::Context* context, mem::Memory* memory,
                           unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalCreate(comm::Context* context, mem::Memory* memory,
                             unsigned args_ptr) {
  struct __attribute__((packed)) {
    uint32_t status;
  ...
  // Create signal
  uint64_t signal_handler = signal_manager->CreateSignal(data.initial_value);
...
int Driver::CallSignalDestroy(comm::Context* context, mem::Memory* memory,
                              unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalLoadRelaxed(comm::Context* context, mem::Memory* memory,
                                  unsigned args_ptr) {
  struct __attribute__((packed)) {
    int64_t value;
    uint64_t signal;
...
int Driver::CallSignalLoadAcquire(comm::Context* context, mem::Memory* memory,
                                  unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalStoreRelaxed(comm::Context* context, mem::Memory* memory,
                                   unsigned args_ptr) {
  struct __attribute__((packed)) {
    uint64_t signal;
    int64_t value;
...
int Driver::CallSignalStoreRelease(comm::Context* context, mem::Memory* memory,
                                   unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalWaitRelaxed(comm::Context* context, mem::Memory* memory,
                                  unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalWaitAcquire(comm::Context* context, mem::Memory* memory,
                                  unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAndRelaxed(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAndAcquire(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAndRelease(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAndAcqRel(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalOrRelaxed(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalOrAcquire(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalOrRelease(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalOrAcqRel(comm::Context* context, mem::Memory* memory,
                               unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalXorRelaxed(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalXorAcquire(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalXorRelease(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalXorAcqRel(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAddRelaxed(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAddAcquire(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAddRelease(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalAddAcqRel(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}
...
int Driver::CallSignalCasRelaxed(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalCasAcquire(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalCasRelease(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallSignalCasAcqRel(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}

int Driver::CallStatusString(comm::Context* context, mem::Memory* memory,
                             unsigned args_ptr) {
  __UNIMPLEMENTED__
  return 0;
}
...
int Driver::CallProgramCreate(comm::Context* context, mem::Memory* memory,
  ...
  unsigned int machine_model =
      getArgumentValue<unsigned int>(4, memory, args_ptr);
  unsigned int profile = getArgumentValue<unsigned int>(8, memory, args_ptr);
  unsigned int rounding = getArgumentValue<unsigned int>(12, memory, args_ptr);
...
int Driver::CallProgramAddModule(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  // Arguments		| Offset	| Size
  // hsa_status_t		| 0		| 4
  // program		| 4		| 8
...
int Driver::CallProgramFinalize(comm::Context* context, mem::Memory* memory,
                                unsigned args_ptr) {
  // Arguments		| Offset	| Size
  // hsa_status_t		| 0		| 4
  // program		| 4		| 8
  ...
  unsigned long long program =
      getArgumentValue<unsigned long long>(4, memory, args_ptr);
  unsigned long long code_object =
      getArgumentValue<unsigned long long>(180, memory, args_ptr);
...
int Driver::CallProgramDestroy(comm::Context* context, mem::Memory* memory,
                               unsigned args_ptr) {
  return 0;
}

int Driver::CallExecutableCreate(comm::Context* context, mem::Memory* memory,
                                 unsigned args_ptr) {
  struct __attribute__((packed)) {
    uint32_t status;
    uint32_t profile;
...
int Driver::CallExecutableLoadCodeObject(comm::Context* context,
  ...
  // Create executable
  ((HsaExecutable*)data.executable)
      ->LoadCodeObject((HsaCodeObject*)data.code_object);
...
int Driver::CallExecutableGetSymbol(comm::Context* context, mem::Memory* memory,
                                    unsigned args_ptr) {
  struct __attribute__((packed)) {
    uint32_t status;
    uint64_t executable;
...
int Driver::CallExecutableSymbolGetInfo(comm::Context* context,
  ...
  memory->Read(args_ptr, sizeof(data), (char*)&data);
  HsaExecutableSymbol* symbol = (HsaExecutableSymbol*)data.executable_symbol;
  ...
  switch (data.attribute) {
    ...
    {
      unsigned int arg_size = symbol->getKernelArgumentSize();
    ...
    default:
      ...
      throw misc::Panic(
          misc::fmt("Unsupported kernel object "
                    "attribute %d.\n",
                    data.attribute));
  }
...
int Driver::CallInitFromX86(comm::Context* context, mem::Memory* memory,
                            unsigned args_ptr) {
...
int Driver::CallNextAgent(comm::Context* context, mem::Memory* memory,
                          unsigned args_ptr) {
  struct __attribute__((packed)) {
  ...
  // Get next component
  Emulator* emulator = Emulator::getInstance();
  Component* component = emulator->getNextComponent(agents.current_agent_id);
...
int Driver::CallNextRegion(comm::Context* context, mem::Memory* memory,
                           unsigned args_ptr) {
  // This function is designed only to be called from the host.
  ...
  unsigned long long curr_region_id =
      getArgumentValue<unsigned long long>(16, memory, args_ptr);
