...
std::map<int, BrigImmed::DumpImmedFn> BrigImmed::dump_immed_fn = {
...
int BrigImmed::getSize() { return type_to_size_map[type]; }

const unsigned char* BrigImmed::dumpImmedNONE(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  dumpImmedUnsupported(os);
  return ptr;
}

const unsigned char* BrigImmed::dumpImmedU8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedU16(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedU32(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedU64(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedSIG32(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int* value = (unsigned int*)ptr;
...
const unsigned char* BrigImmed::dumpImmedSIG64(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned long long* value = (unsigned long long*)ptr;
...
const unsigned char* BrigImmed::dumpImmedS8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
...
const unsigned char* BrigImmed::dumpImmedS16(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = (unsigned char*)this->ptr;
...
const unsigned char* BrigImmed::dumpImmedS32(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = (unsigned char*)this->ptr;
  int* value = (int*)ptr;
  os << misc::fmt("%d", *value);
...
const unsigned char* BrigImmed::dumpImmedS64(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = (unsigned char*)this->ptr;
...
const unsigned char* BrigImmed::dumpImmedF16(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  os << "0H";
  for (int i = 0; i < 2; i++) {
...
const unsigned char* BrigImmed::dumpImmedF32(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  os << "0F";
  for (int i = 0; i < 4; i++) {
...
const unsigned char* BrigImmed::dumpImmedF64(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  os << "0D";
  for (int i = 0; i < 8; i++) {
...
const unsigned char* BrigImmed::dumpImmedB1(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  if (*ptr) {
    os << '1';
...
const unsigned char* BrigImmed::dumpImmedB8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedB16(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedB32(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedB64(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
...
const unsigned char* BrigImmed::dumpImmedB128(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  dumpImmedU64(nullptr, os);
  return ptr + 16;
...
const unsigned char* BrigImmed::dumpImmedSAMP(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  dumpImmedUnsupported(os);
  return ptr;
...
const unsigned char* BrigImmed::dumpImmedROIMG(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  dumpImmedUnsupported(os);
  return ptr;
...
const unsigned char* BrigImmed::dumpImmedRWIMG(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  dumpImmedUnsupported(os);
  return ptr;
...
const unsigned char* BrigImmed::dumpImmedU8X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 1;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedU8X8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 1;
  unsigned int pack = 8;
...
const unsigned char* BrigImmed::dumpImmedU8X16(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 1;
...
const unsigned char* BrigImmed::dumpImmedU16X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedU16X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedU16X8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 8;
...
const unsigned char* BrigImmed::dumpImmedU32X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 4;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedU32X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 4;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedU64X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 8;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedS8X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 1;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedS8X8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 1;
  unsigned int pack = 8;
...
const unsigned char* BrigImmed::dumpImmedS8X16(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 1;
  unsigned int pack = 16;
...
const unsigned char* BrigImmed::dumpImmedS16X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedS16X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedS16X8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 8;
...
const unsigned char* BrigImmed::dumpImmedS32X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 4;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedS32X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 4;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedS64X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 8;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedF16X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedF16X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedF16X8(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 2;
  unsigned int pack = 8;
...
const unsigned char* BrigImmed::dumpImmedF32X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 4;
  unsigned int pack = 2;
...
const unsigned char* BrigImmed::dumpImmedF32X4(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 4;
  unsigned int pack = 4;
...
const unsigned char* BrigImmed::dumpImmedF64X2(
    const unsigned char* ptr = nullptr, std::ostream& os = std::cout) const {
  if (!ptr) ptr = this->ptr;
  unsigned int size = 8;
  unsigned int pack = 2;
