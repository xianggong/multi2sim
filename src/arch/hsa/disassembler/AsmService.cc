...
#define DEFINST(name, opcode, opstr) {opstr, opcode},
#include "Instruction.def"
#undef DEFINST

    {"invalid", 65535}};

misc::StringMap AsmService::type_to_str_map = {{"", BRIG_TYPE_NONE},
                                               {"u8", BRIG_TYPE_U8},
                                               {"u16", BRIG_TYPE_U16},
                                               {"u32", BRIG_TYPE_U32},
                                               {"u64", BRIG_TYPE_U64},
...
std::map<int, unsigned> AsmService::type_to_size_map = {
    {BRIG_TYPE_NONE, 0},         {BRIG_TYPE_U8, 1},
    {BRIG_TYPE_U16, 2},          {BRIG_TYPE_U32, 4},
    {BRIG_TYPE_U64, 8},          {BRIG_TYPE_S8, 1},
    {BRIG_TYPE_S16, 2},          {BRIG_TYPE_S32, 4},
    {BRIG_TYPE_S64, 8},          {BRIG_TYPE_F16, 2},
    {BRIG_TYPE_F32, 4},          {BRIG_TYPE_F64, 8},
    {BRIG_TYPE_B1, 1},           {BRIG_TYPE_B8, 1},
    {BRIG_TYPE_B16, 2},          {BRIG_TYPE_B32, 4},
    {BRIG_TYPE_B64, 8},          {BRIG_TYPE_B128, 16},
    {BRIG_TYPE_SAMP, 0},         {BRIG_TYPE_ROIMG, 0},
    {BRIG_TYPE_WOIMG, 0},        {BRIG_TYPE_RWIMG, 0},
    {BRIG_TYPE_SIG32, 4},        {BRIG_TYPE_SIG64, 8},

    {BRIG_TYPE_U8X4, 4},         {BRIG_TYPE_U8X8, 8},
    {BRIG_TYPE_U8X16, 16},       {BRIG_TYPE_U16X2, 4},
    {BRIG_TYPE_U16X4, 8},        {BRIG_TYPE_U16X8, 16},
    {BRIG_TYPE_U32X2, 8},        {BRIG_TYPE_U32X4, 16},
    {BRIG_TYPE_U64X2, 16},       {BRIG_TYPE_S8X4, 4},
    {BRIG_TYPE_S8X8, 8},         {BRIG_TYPE_S8X16, 16},
    {BRIG_TYPE_S16X2, 4},        {BRIG_TYPE_S16X4, 8},
    {BRIG_TYPE_S16X8, 16},       {BRIG_TYPE_S32X2, 8},
    {BRIG_TYPE_S32X4, 16},       {BRIG_TYPE_S64X2, 16},
    {BRIG_TYPE_F16X2, 4},        {BRIG_TYPE_F16X4, 8},
    {BRIG_TYPE_F16X8, 16},       {BRIG_TYPE_F32X2, 8},
    {BRIG_TYPE_F32X4, 16},       {BRIG_TYPE_F64X2, 16},

    {BRIG_TYPE_U8_ARRAY, 1},     {BRIG_TYPE_U16_ARRAY, 2},
    {BRIG_TYPE_U32_ARRAY, 4},    {BRIG_TYPE_U64_ARRAY, 8},
    {BRIG_TYPE_S8_ARRAY, 1},     {BRIG_TYPE_S16_ARRAY, 2},
    {BRIG_TYPE_S32_ARRAY, 4},    {BRIG_TYPE_S64_ARRAY, 8},
    {BRIG_TYPE_F16_ARRAY, 2},    {BRIG_TYPE_F32_ARRAY, 4},
    {BRIG_TYPE_F64_ARRAY, 8},    {BRIG_TYPE_B8_ARRAY, 1},
    {BRIG_TYPE_B16_ARRAY, 2},    {BRIG_TYPE_B32_ARRAY, 4},
    {BRIG_TYPE_B64_ARRAY, 8},    {BRIG_TYPE_B128_ARRAY, 16},
    {BRIG_TYPE_SAMP_ARRAY, 0},   {BRIG_TYPE_ROIMG_ARRAY, 0},
    {BRIG_TYPE_WOIMG_ARRAY, 0},  {BRIG_TYPE_RWIMG_ARRAY, 0},
    {BRIG_TYPE_SIG32_ARRAY, 4},  {BRIG_TYPE_SIG64_ARRAY, 8},
    {BRIG_TYPE_U8X4_ARRAY, 4},   {BRIG_TYPE_U8X8_ARRAY, 8},
    {BRIG_TYPE_U8X16_ARRAY, 16}, {BRIG_TYPE_U16X2_ARRAY, 4},
    {BRIG_TYPE_U16X4_ARRAY, 8},  {BRIG_TYPE_U16X8_ARRAY, 16},
    {BRIG_TYPE_U32X2_ARRAY, 8},  {BRIG_TYPE_U32X4_ARRAY, 16},
    {BRIG_TYPE_U64X2_ARRAY, 16}, {BRIG_TYPE_S8X4_ARRAY, 4},
    {BRIG_TYPE_S8X8_ARRAY, 8},   {BRIG_TYPE_S8X16_ARRAY, 16},
    {BRIG_TYPE_S16X2_ARRAY, 4},  {BRIG_TYPE_S16X4_ARRAY, 8},
    {BRIG_TYPE_S16X8_ARRAY, 16}, {BRIG_TYPE_S32X2_ARRAY, 8},
    {BRIG_TYPE_S32X4_ARRAY, 16}, {BRIG_TYPE_S64X2_ARRAY, 16},
    {BRIG_TYPE_F16X2_ARRAY, 4},  {BRIG_TYPE_F16X4_ARRAY, 8},
    {BRIG_TYPE_F16X8_ARRAY, 16}, {BRIG_TYPE_F32X2_ARRAY, 8},
    {BRIG_TYPE_F32X4_ARRAY, 16}, {BRIG_TYPE_F64X2_ARRAY, 16}};
...
misc::StringMap AsmService::segment_to_str_map = {
    {"", BRIG_SEGMENT_NONE},           {"", BRIG_SEGMENT_FLAT},
    {"global", BRIG_SEGMENT_GLOBAL},   {"readonly", BRIG_SEGMENT_READONLY},
    {"kernarg", BRIG_SEGMENT_KERNARG}, {"group", BRIG_SEGMENT_GROUP},
    {"private", BRIG_SEGMENT_PRIVATE}, {"spill", BRIG_SEGMENT_SPILL},
...
misc::StringMap AsmService::compare_operation_to_str_map = {
    {"eq", BRIG_COMPARE_EQ},     {"ne", BRIG_COMPARE_NE},
    {"lt", BRIG_COMPARE_LT},     {"le", BRIG_COMPARE_LE},
    {"gt", BRIG_COMPARE_GT},     {"ge", BRIG_COMPARE_GE},
    {"equ", BRIG_COMPARE_EQU},   {"neu", BRIG_COMPARE_NEU},
    {"ltu", BRIG_COMPARE_LTU},   {"leu", BRIG_COMPARE_LEU},
    {"gtu", BRIG_COMPARE_GTU},   {"geu", BRIG_COMPARE_GEU},
    {"num", BRIG_COMPARE_NUM},   {"nan", BRIG_COMPARE_NAN},
    {"seq", BRIG_COMPARE_SEQ},   {"sne", BRIG_COMPARE_SNE},
    {"slt", BRIG_COMPARE_SLT},   {"sle", BRIG_COMPARE_SLE},
    {"sgt", BRIG_COMPARE_SGT},   {"sge", BRIG_COMPARE_SGE},
    {"sgeu", BRIG_COMPARE_SGEU}, {"sequ", BRIG_COMPARE_SEQU},
    {"sneu", BRIG_COMPARE_SNEU}, {"sltu", BRIG_COMPARE_SLTU},
    {"sleu", BRIG_COMPARE_SLEU}, {"snum", BRIG_COMPARE_SNUM},
    {"snan", BRIG_COMPARE_SNAN}, {"sgtu", BRIG_COMPARE_SGTU}};
...
misc::StringMap AsmService::pack_to_str_map = {
    {"", BRIG_PACK_NONE},        {"pp", BRIG_PACK_PP},
    {"ps", BRIG_PACK_PS},        {"sp", BRIG_PACK_SP},
    {"ss", BRIG_PACK_SS},        {"s", BRIG_PACK_S},
    {"p", BRIG_PACK_P},          {"pp_sat", BRIG_PACK_PPSAT},
    {"ps_sat", BRIG_PACK_PSSAT}, {"sp_sat", BRIG_PACK_SPSAT},
    {"ss_sat", BRIG_PACK_SSSAT}, {"s_sat", BRIG_PACK_SSAT},
...
misc::StringMap AsmService::image_geometry_to_str_map = {
    {"1d", BRIG_GEOMETRY_1D},           {"2d", BRIG_GEOMETRY_2D},
    {"3d", BRIG_GEOMETRY_3D},           {"1da", BRIG_GEOMETRY_1DA},
    {"1db", BRIG_GEOMETRY_1DB},         {"2da", BRIG_GEOMETRY_2DA},
    {"2ddepth", BRIG_GEOMETRY_2DDEPTH}, {"2dadepth", BRIG_GEOMETRY_2DADEPTH},
};
...
bool AsmService::isInteger(BrigType type) {
  if (type == BRIG_TYPE_U8 || type == BRIG_TYPE_U16 || type == BRIG_TYPE_U32 ||
      type == BRIG_TYPE_U64 || type == BRIG_TYPE_S8 || type == BRIG_TYPE_S16 ||
      type == BRIG_TYPE_S32 || type == BRIG_TYPE_S64)
    return true;
  return false;
}

bool AsmService::isFloat(BrigType type) {
  if (type == BRIG_TYPE_F16 || type == BRIG_TYPE_F32 || type == BRIG_TYPE_F64)
    return true;
  return false;
}

bool AsmService::isPacked(BrigType type) {
  if ((type & BRIG_TYPE_PACK_32) || (type & BRIG_TYPE_PACK_64) ||
...
bool AsmService::isArray(BrigType type) {
  if (type & BRIG_TYPE_ARRAY) return true;
  return false;
}
...
std::string AsmService::AllocationToString(BrigAllocation allocation,
                                           BrigSegment segment) {
  if (allocation == BRIG_ALLOCATION_AGENT && segment != BRIG_SEGMENT_READONLY)
    return "alloc(agent)";
  return "";
}
...
std::string AsmService::VectorModifierToString(unsigned vectorModifier) {
  switch (vectorModifier) {
    ...
    default:
      throw misc::Panic(
          misc::fmt("Invalid vector modifier v%d", vectorModifier));
  }
}
...
std::string AsmService::AtomicOperationToString(
