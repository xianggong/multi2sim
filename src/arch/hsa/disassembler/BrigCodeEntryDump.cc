...
std::map<unsigned, BrigCodeEntry::DumpEntryFn> BrigCodeEntry::dump_entry_fn = {
    ...
    {BRIG_KIND_DIRECTIVE_INDIRECT_FUNCTION,
     &BrigCodeEntry::DumpDirIndirectFunction},
...
void BrigCodeEntry::DumpIndent(std::ostream& os = std::cout) const {
  ...
  for (int i = 0; i < disassembler->getIndent(); i++) os << "\t";
}
...
void BrigCodeEntry::DumpDirFbarrier(std::ostream& os = std::cout) const {
  DumpIndent(os);
  AsmService::DumpWithSpace(AsmService::DeclToString(!isDefinition()), os);
  AsmService::DumpWithSpace(AsmService::LinkageToString(getLinkage()), os);
  os << "fbarrier " << getName() << ";\n";
}
...
void BrigCodeEntry::DumpDirIndirectFunction(
...
void BrigCodeEntry::DumpDirModule(std::ostream& os = std::cout) const {
  ...
  std::string roundStr = AsmService::RoundingToString(getDefaultFloatRound());
  if (roundStr == "") roundStr = "$default";
  os << roundStr << ";\n";
}
...
void BrigCodeEntry::DumpInstAddr(std::ostream& os = std::cout) const {
  ...
  AsmService::DumpUnderscore(AsmService::SegmentToString(getSegment()), os);
...
void BrigCodeEntry::DumpInstAtomic(std::ostream& os = std::cout) const {
  ...
  AsmService::DumpUnderscore(
      AsmService::AtomicOperationToString(getAtomicOperation()), os);
  AsmService::DumpUnderscore(AsmService::SegmentToString(getSegment()), os);
  AsmService::DumpUnderscore(AsmService::MemoryOrderToString(getMemoryOrder()),
                             os);
  AsmService::DumpUnderscore(AsmService::MemoryScopeToString(getMemoryScope()),
                             os);

  // Dump equiv class
  if (getEquivClass() != 0) {
    AsmService::DumpUnderscore(AsmService::EquivClassToString(getEquivClass()),
                               os);
  }
  AsmService::DumpUnderscore(AsmService::TypeToString(getType()), os);
  DumpOperands(os);
...
void BrigCodeEntry::DumpInstBr(std::ostream& os = std::cout) const {
  ...
  if (getDefaultWidth() != getWidth())
    AsmService::DumpUnderscore(AsmService::WidthToString(getWidth()), os);
...
void BrigCodeEntry::DumpInstCmp(std::ostream& os = std::cout) const {
  ...
  os << AsmService::OpcodeToString(getOpcode());
  AsmService::DumpUnderscore(
      AsmService::CompareOperationToString(getCompareOperation()), os);
  AsmService::DumpUnderscore(AsmService::AluModifierToString(getAluModifier()),
                             os);
  // AsmService::DumpUnderscore(AsmService::RoundingToString(
  //		getRounding()), os);
  AsmService::DumpUnderscore(AsmService::PackToString(getPack()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getType()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getSourceType()), os);
...
void BrigCodeEntry::DumpInstCvt(std::ostream& os = std::cout) const {
  ...
  if (getRound() != getDefaultRounding()) {
    AsmService::DumpUnderscore(AsmService::RoundingToString(getRound()), os);
  }
  AsmService::DumpUnderscore(AsmService::TypeToString(getType()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getSourceType()), os);
  DumpOperands(os);
...
void BrigCodeEntry::DumpInstImage(std::ostream& os = std::cout) const {
  ...
  os << AsmService::OpcodeToString(getOpcode());
  AsmService::DumpUnderscore(
      AsmService::VectorModifierToString(getVectorModifier()), os);
  AsmService::DumpUnderscore(AsmService::ImageGeometryToString(getGeometry()),
                             os);
  if (getEquivClass() != 0) {
    AsmService::DumpUnderscore(AsmService::EquivClassToString(getEquivClass()),
                               os);
  ...
  AsmService::DumpUnderscore(AsmService::TypeToString(getType()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getImageType()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getCoordType()), os);
  DumpOperands(os);
  os << ";\n";
}
...
void BrigCodeEntry::DumpInstMemFence(std::ostream& os = std::cout) const {
  ...
  if (getGlobalSegmentScope() != BRIG_MEMORY_SCOPE_NONE) {
    AsmService::DumpUnderscore(
        AsmService::MemoryScopeToString(getGlobalSegmentScope()), os);
  }
  os << ";\n";
}
...
void BrigCodeEntry::DumpInstQueryImage(std::ostream& os = std::cout) const {
  ...
  AsmService::DumpUnderscore(AsmService::ImageGeometryToString(getGeometry()),
                             os);
  AsmService::DumpUnderscore(AsmService::ImageQueryToString(getImageQuery()),
                             os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getType()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getImageType()), os);
  DumpOperands(os);
...
void BrigCodeEntry::DumpInstQuerySampler(std::ostream& os = std::cout) const {
  ...
  os << AsmService::OpcodeToString(getOpcode());
  AsmService::DumpUnderscore(
      AsmService::SamplerQueryToString(getSamplerQuery()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getType()), os);
  DumpOperands(os);
  os << ";\n";
}
...
void BrigCodeEntry::DumpInstSignal(std::ostream& os = std::cout) const {
  ...
  os << AsmService::OpcodeToString(getOpcode());
  AsmService::DumpUnderscore(
      AsmService::AtomicOperationToString(getSignalOperation()), os);
  AsmService::DumpUnderscore(AsmService::MemoryOrderToString(getMemoryOrder()),
                             os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getType()), os);
  AsmService::DumpUnderscore(AsmService::TypeToString(getSignalType()), os);
  DumpOperands(os);
  os << ";\n";
}
...
void BrigCodeEntry::DumpSymbolDeclaration(std::ostream& os = std::cout) const {
  AsmService::DumpWithSpace(AsmService::DeclToString(!isDefinition()), os);
  AsmService::DumpWithSpace(AsmService::LinkageToString(getLinkage()), os);
  AsmService::DumpWithSpace(
      AsmService::AllocationToString(getAllocation(), getSegment()), os);
  // FIXME: add align support
  AsmService::DumpWithSpace(AsmService::ConstToString(isConst()), os);
...
void BrigCodeEntry::DumpCallArguments(std::ostream& os = std::cout) const {
  if (!isCallInst()) throw misc::Panic("DumpCallArgument not valid for kind");
  ...
  if (getOperandCount() >= 4) {
    ...
    if (operand3->getKind() == BRIG_KIND_OPERAND_CODE_LIST) {
      os << " [";
      for (unsigned int i = 0; i < operand3->getElementCount(); i++) {
        if (i > 0) os << ", ";
...
void BrigCodeEntry::KindError(const std::string& str) const {
  throw misc::Panic(misc::fmt("%s not valid for kind %s", str.c_str(),
