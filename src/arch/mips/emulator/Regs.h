...
class Regs {
 ...
 public:
  ...
  unsigned int getCoprocessor0GPR(int n) { return coprocessor0_gpr[n]; }

  /// Set the value of a single precision floating point register
  void setSinglePrecisionFPR(int n, float value) {
    fpr.SinglePrecicion[n] = value;
  }

  /// Set the value of a double precision floating point register
  void setDoublePrecisionFPR(int n, float value) {
    fpr.DoublePrecision[n] = value;
  }
