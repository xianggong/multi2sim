...
class Disassembler : public comm::Disassembler {
 public:
  /// Disassembly Mode
  enum DisassemblyMode { DisassemblyModeArm = 1, DisassemblyModeThumb };
 ...
 public:
  ...
  void Thumb32SetupTable(const char* name, const char* fmt_str,
                         Instruction::Thumb32Category cat32, int op1, int op2,
                         int op3, int op4, int op5, int op6, int op7, int op8,
                         Instruction::Thumb32Opcode inst_name);
  void Thumb16SetupTable(const char* name, const char* fmt_str,
                         Instruction::Thumb16Category cat16, int op1, int op2,
  ...
  void ElfSymbolFunc(const ELFReader::File& file, std::ostream& os,
                     unsigned int inst_addr, DisassemblyMode disasm_mode);
