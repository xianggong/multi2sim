...
void Emulator::RegisterOptions() {
  ...
  command_line->RegisterString(
      "--arm-debug-loader <file>", loader_debug_file,
  ...
  command_line->RegisterString(
      "--arm-debug-syscall <file>", syscall_debug_file,
