...
#define op_xxx_rm8_1_impl(xxx, idep)                                    \
  void Context::ExecuteInst_##xxx##_rm8_1() {                           \
    ...
    newUinst(Uinst::OpcodeShift, idep, Uinst::DepRm8, 0, Uinst::DepRm8, \
...
#define op_xxx_rm8_cl_impl(xxx, idep)                                \
  void Context::ExecuteInst_##xxx##_rm8_cl() {                       \
    ...
    StoreRm8(rm8);                                                   \
    regs.setEflags(flags);                                           \
    newUinst(Uinst::OpcodeShift, idep, Uinst::DepRm8, Uinst::DepEcx, \
             Uinst::DepRm8, Uinst::DepCf, Uinst::DepOf, 0);          \
  }
...
#define op_xxx_rm16_1_impl(xxx, idep)                                     \
  void Context::ExecuteInst_##xxx##_rm16_1() {                            \
    ...
    StoreRm16(rm16);                                                      \
    regs.setEflags(flags);                                                \
    newUinst(Uinst::OpcodeShift, idep, Uinst::DepRm16, 0, Uinst::DepRm16, \
             Uinst::DepCf, Uinst::DepOf, 0);                              \
  }
...
#define op_xxx_rm16_cl_impl(xxx, idep)                                \
  void Context::ExecuteInst_##xxx##_rm16_cl() {                       \
    ...
    StoreRm16(rm16);                                                  \
    regs.setEflags(flags);                                            \
    newUinst(Uinst::OpcodeShift, idep, Uinst::DepRm16, Uinst::DepEcx, \
             Uinst::DepRm16, Uinst::DepCf, Uinst::DepOf, 0);          \
  }
...
#define op_xxx_rm32_1_impl(xxx, idep)                                     \
  void Context::ExecuteInst_##xxx##_rm32_1() {                            \
    ...
    StoreRm32(rm32);                                                      \
    regs.setEflags(flags);                                                \
    newUinst(Uinst::OpcodeShift, idep, Uinst::DepRm32, 0, Uinst::DepRm32, \
             Uinst::DepCf, Uinst::DepOf, 0);                              \
  }
...
#define op_xxx_rm32_cl_impl(xxx, idep)                                \
  void Context::ExecuteInst_##xxx##_rm32_cl() {                       \
    ...
    StoreRm32(rm32);                                                  \
    regs.setEflags(flags);                                            \
    newUinst(Uinst::OpcodeShift, idep, Uinst::DepRm32, Uinst::DepEcx, \
             Uinst::DepRm32, Uinst::DepCf, Uinst::DepOf, 0);          \
  }
...
op_xxx_all(rcl, Uinst::DepCf) op_xxx_all(rcr, Uinst::DepCf) op_xxx_all(rol, 0)
    op_xxx_all(ror, 0)
