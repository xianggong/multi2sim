...
#define op_stdop_al_imm8(stdop, wb, cin, uinst)                                \
  void Context::ExecuteInst_##stdop##_al_imm8() {                              \
    ...
    if (wb) {                                                                  \
      ...
      newUinst(uinst, Uinst::DepEax, cin_dep, 0, Uinst::DepEax, Uinst::DepZps, \
               Uinst::DepCf, Uinst::DepOf);                                    \
    } else {                                                                   \
      newUinst(uinst, Uinst::DepEax, cin_dep, 0, Uinst::DepZps, Uinst::DepCf,  \
               Uinst::DepOf, 0);                                               \
    }                                                                          \
...
#define op_stdop_rm8_imm8(stdop, wb, cin, uinst)                               \
  void Context::ExecuteInst_##stdop##_rm8_imm8() {                             \
    ...
    if (wb) {                                                                  \
      StoreRm8(rm8);                                                           \
      newUinst(uinst, Uinst::DepRm8, cin_dep, 0, Uinst::DepRm8, Uinst::DepZps, \
               Uinst::DepCf, Uinst::DepOf);                                    \
    } else {                                                                   \
      newUinst(uinst, Uinst::DepRm8, cin_dep, 0, Uinst::DepZps, Uinst::DepCf,  \
               Uinst::DepOf, 0);                                               \
    }                                                                          \
    regs.setEflags(flags);                                                     \
  }
...
#define op_stdop_rm16_imm16(stdop, wb, cin, uinst)                             \
  void Context::ExecuteInst_##stdop##_rm16_imm16() {                           \
    ...
    if (wb) {                                                                  \
      ...
      newUinst(uinst, Uinst::DepRm16, cin_dep, 0, Uinst::DepZps, Uinst::DepCf, \
               Uinst::DepOf, 0);                                               \
    }                                                                          \
    regs.setEflags(flags);                                                     \
  }
...
#define op_stdop_rm32_imm32(stdop, wb, cin, uinst)                             \
  void Context::ExecuteInst_##stdop##_rm32_imm32() {                           \
    ...
    if (wb) {                                                                  \
      ...
      newUinst(uinst, Uinst::DepRm32, cin_dep, 0, Uinst::DepZps, Uinst::DepCf, \
               Uinst::DepOf, 0);                                               \
    }                                                                          \
    regs.setEflags(flags);                                                     \
  }
...
#define op_stdop_r32_rm32(stdop, wb, cin, uinst)                             \
  void Context::ExecuteInst_##stdop##_r32_rm32() {                           \
    ...
    if (wb) {                                                                \
      StoreR32(r32);                                                         \
      newUinst(uinst, Uinst::DepR32, Uinst::DepRm32, cin_dep, Uinst::DepR32, \
               Uinst::DepZps, Uinst::DepCf, Uinst::DepOf);                   \
    } else {                                                                 \
      newUinst(uinst, Uinst::DepR32, Uinst::DepRm32, cin_dep, Uinst::DepZps, \
               Uinst::DepCf, Uinst::DepOf, 0);                               \
    }                                                                        \
    regs.setEflags(flags);                                                   \
  }
