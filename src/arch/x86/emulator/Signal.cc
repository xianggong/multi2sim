...
const misc::StringMap signal_map = {
    ...
    {"SIGIO", 29},   {"SIGPWR", 30},    {"SIGSYS", 31},  {"SIGWAITING", 32},
    {"SIGLWP", 33}};

const misc::StringMap signal_handler_flags_map = {
    {"SA_NOCLDSTOP", 0x00000001u},      {"SA_NOCLDWAIT", 0x00000002u},
    {"SA_SIGINFO", 0x00000004u},        {"SA_ONSTACK", 0x08000000u},
    {"SA_RESTART", 0x10000000u},        {"SA_NODEFER", 0x40000000u},
    {"SA_RESETHAND", (int)0x80000000u}, {"SA_INTERRUPT", 0x20000000u},
...
void SignalHandler::Dump(std::ostream& os) const {
  os << misc::fmt("handler = 0x%x, ", handler)
     ...
     << misc::fmt("restorer = 0x%x, ", restorer) << "mask = " << mask;
}
