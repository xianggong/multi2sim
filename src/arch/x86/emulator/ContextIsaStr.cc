  ...
  void Context::ExecuteInst_rep_##X() {                                      \
    ...
    if (regs.getEcx()) {                                                     \
      ...
      regs.decEip(inst.getSize());                                           \
                                                                             ...
                                                                             \
    newUinst_##X(str_op_esi + str_op_count * (SIZE)*str_op_dir,              \
                 str_op_edi + str_op_count * (SIZE)*str_op_dir);             \
    newUinst(Uinst::OpcodeSub, Uinst::DepEcx, 0, 0, Uinst::DepEcx, 0, 0, 0); \
    newUinst(Uinst::OpcodeIbranch, Uinst::DepEcx, 0, 0, 0, 0, 0, 0);         \
  }
...
#define OP_REPZ_IMPL(X, SIZE)                                                \
  void Context::ExecuteInst_repz_##X() {                                     \
    ...
    if (regs.getEcx()) {                                                     \
      ExecuteStringInst_##X();                                               \
      regs.decEcx();                                                         \
      if (regs.getFlag(Instruction::FlagZF)) regs.decEip(inst.getSize());    \
    }                                                                        \
                                                                             \
    newUinst_##X(str_op_esi + str_op_count * (SIZE)*str_op_dir,              \
                 str_op_edi + str_op_count * (SIZE)*str_op_dir);             \
    newUinst(Uinst::OpcodeSub, Uinst::DepEcx, 0, 0, Uinst::DepEcx, 0, 0, 0); \
    newUinst(Uinst::OpcodeIbranch, Uinst::DepEcx, Uinst::DepZps, 0, 0, 0, 0, \
             0);                                                             \
  }
...
void Context::newUinst_cmpsb(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeLoad, esi, 1, Uinst::DepEsi, 0, 0, Uinst::DepAux,
                 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, edi, 1, Uinst::DepEdi, 0, 0, Uinst::DepAux2,
                 0, 0, 0);
  newUinst(Uinst::OpcodeSub, Uinst::DepAux, Uinst::DepAux2, 0, Uinst::DepZps,
           Uinst::DepOf, Uinst::DepCf, 0);

  newUinst(Uinst::OpcodeAdd, Uinst::DepEsi, Uinst::DepDf, 0, Uinst::DepEsi, 0,
           0, 0);
  newUinst(Uinst::OpcodeAdd, Uinst::DepEdi, Uinst::DepDf, 0, Uinst::DepEdi, 0,
           0, 0);
}
...
void Context::newUinst_cmpsd(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeLoad, esi, 4, Uinst::DepEsi, 0, 0, Uinst::DepAux,
                 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, edi, 4, Uinst::DepEdi, 0, 0, Uinst::DepAux2,
                 0, 0, 0);
  newUinst(Uinst::OpcodeSub, Uinst::DepAux, Uinst::DepAux2, 0, Uinst::DepZps,
           Uinst::DepOf, Uinst::DepCf, 0);
...
void Context::newUinst_movsb(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeLoad, esi, 1, Uinst::DepEsi, 0, 0, Uinst::DepAux,
                 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, edi, 1, Uinst::DepEdi, Uinst::DepAux, 0, 0,
                 0, 0, 0);
...
void Context::newUinst_movsd(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeLoad, esi, 4, Uinst::DepEsi, 0, 0, Uinst::DepAux,
                 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, edi, 4, Uinst::DepEdi, Uinst::DepAux, 0, 0,
                 0, 0, 0);
...
void Context::newUinst_scasb(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeLoad, edi, 1, Uinst::DepEdi, 0, 0, Uinst::DepAux,
                 0, 0, 0);
  newUinst(Uinst::OpcodeSub, Uinst::DepAux, Uinst::DepEax, 0, Uinst::DepZps,
           Uinst::DepOf, Uinst::DepCf, 0);
  newUinst(Uinst::OpcodeAdd, Uinst::DepEdi, Uinst::DepDf, 0, Uinst::DepEdi, 0,
           0, 0);
}
...
void Context::newUinst_scasd(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeLoad, edi, 4, Uinst::DepEdi, 0, 0, Uinst::DepAux,
                 0, 0, 0);
  newUinst(Uinst::OpcodeSub, Uinst::DepAux, Uinst::DepEax, 0, Uinst::DepZps,
           Uinst::DepOf, Uinst::DepCf, 0);
  newUinst(Uinst::OpcodeAdd, Uinst::DepEdi, Uinst::DepDf, 0, Uinst::DepEdi, 0,
...
void Context::newUinst_stosb(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeStore, edi, 1, Uinst::DepEdi, Uinst::DepEax, 0, 0,
                 0, 0, 0);
  newUinst(Uinst::OpcodeAdd, Uinst::DepEdi, Uinst::DepDf, 0, Uinst::DepEdi, 0,
           0, 0);
}
...
void Context::newUinst_stosd(unsigned int esi, unsigned int edi) {
  newMemoryUinst(Uinst::OpcodeStore, edi, 4, Uinst::DepEdi, Uinst::DepEax, 0, 0,
                 0, 0, 0);
  newUinst(Uinst::OpcodeAdd, Uinst::DepEdi, Uinst::DepDf, 0, Uinst::DepEdi, 0,
           0, 0);
}
