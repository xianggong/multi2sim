...
class Emulator : public comm::Emulator {
 ...
 public:
  ...
  int getNumRunningContexts() const { return running_contexts.size(); }
  ...
  int getNumSuspendedContexts() const { return suspended_contexts.size(); }
  ...
  int getNumFinishedContexts() const { return finished_contexts.size(); }
  ...
  int getNumZombieContexts() const { return zombie_contexts.size(); }
