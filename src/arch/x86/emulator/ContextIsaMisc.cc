...
void Context::ExecuteInst_bsf_r32_rm32() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm32, 0, 0, Uinst::DepR32,
           Uinst::DepZps, 0, 0);
}
...
void Context::ExecuteInst_bswap_ir32() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepIr32, 0, 0, Uinst::DepIr32, 0, 0, 0);
}
...
void Context::ExecuteInst_bt_rm32_r32() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm32, Uinst::DepR32, 0, Uinst::DepCf,
           0, 0, 0);
}
...
void Context::ExecuteInst_bt_rm32_imm8() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm32, 0, 0, Uinst::DepCf, 0, 0, 0);
}
...
void Context::ExecuteInst_bts_rm32_imm8() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm32, 0, 0, Uinst::DepRm32,
           Uinst::DepCf, 0, 0);
}
...
void Context::ExecuteInst_call_rel32() {
  ...
  // Call stack
  if (call_stack != nullptr) call_stack->Call(target_eip, regs.getEsp());

  // Micro-instructions
  newUinst(Uinst::OpcodeSub, Uinst::DepEsp, 0, 0, Uinst::DepEsp, 0, 0, 0);
  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEsp, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, regs.getEsp(), 4, Uinst::DepAux, 0, 0, 0,
                 0, 0, 0);
...
void Context::ExecuteInst_call_rm32() {
  ...
  newMemoryUinst(Uinst::OpcodeStore, regs.getEsp(), 4, Uinst::DepAux, 0, 0, 0,
                 0, 0, 0);
  newUinst(Uinst::OpcodeCall, Uinst::DepRm32, 0, 0, 0, 0, 0, 0);
}
...
void Context::ExecuteInst_cbw() {
  ...
  newUinst(Uinst::OpcodeSign, Uinst::DepEax, 0, 0, Uinst::DepEax, 0, 0, 0);
}
...
void Context::ExecuteInst_cdq() {
  ...
  newUinst(Uinst::OpcodeSign, Uinst::DepEax, 0, 0, Uinst::DepEdx, 0, 0, 0);
}

void Context::ExecuteInst_cld() {
  regs.clearFlag(Instruction::FlagDF);

  newUinst(Uinst::OpcodeMove, 0, 0, 0, 0, Uinst::DepDf, 0, 0);
}
...
void Context::ExecuteInst_cmpxchg_rm32_r32() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepEax, Uinst::DepRm32, 0, Uinst::DepZps,
           Uinst::DepCf, Uinst::DepOf, 0);
  newUinst(Uinst::OpcodeMove, Uinst::DepZps, Uinst::DepR32, 0, Uinst::DepRm32,
           0, 0, 0);
  newUinst(Uinst::OpcodeMove, Uinst::DepCf, Uinst::DepRm32, 0, Uinst::DepEax, 0,
           0, 0);
}
...
void Context::ExecuteInst_cmpxchg8b_m64() {
  ...
  newMemoryUinst(Uinst::OpcodeLoad, getEffectiveAddress(), 8, 0, 0, 0,
                 Uinst::DepAux, 0, 0,
                 0);  // Load m64
  newUinst(Uinst::OpcodeSub, Uinst::DepEdx, Uinst::DepEax, Uinst::DepAux,
           Uinst::DepZps, 0, 0,
           0);  // Compare edx-eax with m64
  newMemoryUinst(Uinst::OpcodeStore, getEffectiveAddress(), 8, Uinst::DepZps,
                 Uinst::DepEcx, Uinst::DepEbx, Uinst::DepMem64, 0, 0,
                 0);  // Conditionally store m64
  newUinst(Uinst::OpcodeMove, Uinst::DepZps, 0, 0, Uinst::DepEdx, Uinst::DepEax,
           0,
...
void Context::ExecuteInst_cpuid() {
  ...
  switch (regs.getEax()) {
    ...
    case 0x1:
      ...
      info =
          misc::setBit32(info, 22, 1);  // ACPI - Thermal Monitor and Clock Ctrl
    ...
    default:
      ...
      throw misc::Panic(
          misc::fmt("Unimplemented for eax = 0x%x", regs.getEax()));
  }

  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepEax, 0, 0, 0);
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepEbx, 0, 0, 0);
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepEcx, 0, 0, 0);
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepEdx, 0, 0, 0);
}
...
void Context::ExecuteInst_dec_rm8() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepRm8, 0, 0, Uinst::DepRm8, Uinst::DepZps,
           Uinst::DepOf, 0);
}
...
void Context::ExecuteInst_dec_rm16() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepRm16, 0, 0, Uinst::DepRm16,
           Uinst::DepZps, Uinst::DepOf, 0);
}
...
void Context::ExecuteInst_dec_rm32() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepRm32, 0, 0, Uinst::DepRm32,
           Uinst::DepZps, Uinst::DepOf, 0);
}
...
void Context::ExecuteInst_dec_ir16() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepIr16, 0, 0, Uinst::DepIr16,
           Uinst::DepZps, Uinst::DepOf, 0);
}
...
void Context::ExecuteInst_dec_ir32() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepIr32, 0, 0, Uinst::DepIr32,
           Uinst::DepZps, Uinst::DepOf, 0);
}
...
void Context::ExecuteInst_div_rm8() {
  ...
  if (!rm8) throw Error("Division by 0");
  ...
  newUinst(Uinst::OpcodeDiv, Uinst::DepEax, Uinst::DepRm8, 0, Uinst::DepEax, 0,
           0, 0);
}
...
void Context::ExecuteInst_div_rm32() {
  ...
  if (!rm32) throw Error("Division by 0");
  ...
  newUinst(Uinst::OpcodeDiv, Uinst::DepEdx, Uinst::DepEax, Uinst::DepRm32,
           Uinst::DepEax, Uinst::DepEdx, 0, 0);
}

void Context::ExecuteInst_hlt() { throw Error("Instruction 'hlt' executed"); }
...
void Context::ExecuteInst_idiv_rm32() {
  ...
  newUinst(Uinst::OpcodeDiv, Uinst::DepRm32, Uinst::DepEax, 0, Uinst::DepEax,
           Uinst::DepEdx, 0, 0);
}
...
void Context::ExecuteInst_imul_rm32() {
  ...
  newUinst(Uinst::OpcodeMult, Uinst::DepRm32, Uinst::DepEax, 0, Uinst::DepEax,
           Uinst::DepEdx, Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_imul_r16_rm16() {
  ...
  newUinst(Uinst::OpcodeMult, Uinst::DepR16, Uinst::DepRm16, 0, Uinst::DepR16,
           0, Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_imul_r32_rm32() {
  ...
  newUinst(Uinst::OpcodeMult, Uinst::DepR32, Uinst::DepRm32, 0, Uinst::DepR32,
           0, Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_imul_r32_rm32_imm8() {
  ...
  newUinst(Uinst::OpcodeMult, Uinst::DepRm32, 0, 0, Uinst::DepR32, 0,
           Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_inc_rm8() {
  ...
  newUinst(Uinst::OpcodeAdd, Uinst::DepRm8, 0, 0, Uinst::DepRm8, 0,
           Uinst::DepZps, Uinst::DepOf);
}
...
void Context::ExecuteInst_inc_rm16() {
  ...
  newUinst(Uinst::OpcodeAdd, Uinst::DepRm16, 0, 0, Uinst::DepRm16, 0,
           Uinst::DepZps, Uinst::DepOf);
}
...
void Context::ExecuteInst_inc_rm32() {
  ...
  newUinst(Uinst::OpcodeAdd, Uinst::DepRm32, 0, 0, Uinst::DepRm32, 0,
           Uinst::DepZps, Uinst::DepOf);
}
...
void Context::ExecuteInst_inc_ir16() {
  ...
  newUinst(Uinst::OpcodeAdd, Uinst::DepIr16, 0, 0, Uinst::DepIr16, 0,
           Uinst::DepZps, Uinst::DepOf);
}
...
void Context::ExecuteInst_inc_ir32() {
  ...
  newUinst(Uinst::OpcodeAdd, Uinst::DepIr32, 0, 0, Uinst::DepIr32, 0,
           Uinst::DepZps, Uinst::DepOf);
}
...
void Context::ExecuteInst_int_imm8() {
  ...
  if (num != 0x80)
    throw misc::Panic(
        "Software interrupt not supported for "
...
void Context::ExecuteInst_jmp_rm32() {
  ...
  newUinst(Uinst::OpcodeJump, Uinst::DepRm32, 0, 0, 0, 0, 0, 0);
}

void Context::ExecuteInst_lea_r32_m() {
  unsigned int value = getEffectiveAddress();

  if (inst.getSegment()) throw misc::Panic("Unsupported segment");

  StoreR32(value);

  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEaseg, Uinst::DepEabas,
           Uinst::DepEaidx, Uinst::DepR32, 0, 0, 0);
}
...
void Context::ExecuteInst_leave() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepEbp, 0, 0, Uinst::DepEsp, 0, 0, 0);
  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEsp, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, regs.getEsp() - 4, 4, Uinst::DepAux, 0, 0,
                 Uinst::DepEbp, 0, 0, 0);
  newUinst(Uinst::OpcodeAdd, Uinst::DepEsp, 0, 0, Uinst::DepEsp, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_rm8_imm8() {
  ...
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepRm8, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_r8_rm8() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm8, 0, 0, Uinst::DepR8, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_rm8_r8() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepR8, 0, 0, Uinst::DepRm8, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_rm16_r16() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepR16, 0, 0, Uinst::DepRm16, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_rm32_r32() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepR32, 0, 0, Uinst::DepRm32, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_r16_rm16() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm16, 0, 0, Uinst::DepR16, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_r32_rm32() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm32, 0, 0, Uinst::DepR32, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_al_moffs8() {
  ...
  newUinst(Uinst::OpcodeEffaddr, 0, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, getMoffsAddress(), 1, Uinst::DepAux, 0, 0,
                 Uinst::DepEax, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_ax_moffs16() {
  ...
  newUinst(Uinst::OpcodeEffaddr, 0, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, getMoffsAddress(), 2, Uinst::DepAux, 0, 0,
                 Uinst::DepEax, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_eax_moffs32() {
  ...
  newUinst(Uinst::OpcodeEffaddr, 0, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, getMoffsAddress(), 4, Uinst::DepAux, 0, 0,
                 Uinst::DepEax, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_moffs8_al() {
  ...
  newUinst(Uinst::OpcodeEffaddr, 0, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, getMoffsAddress(), 1, Uinst::DepAux,
                 Uinst::DepEax, 0, 0, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_moffs16_ax() {
  ...
  newUinst(Uinst::OpcodeEffaddr, 0, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, getMoffsAddress(), 2, Uinst::DepAux,
                 Uinst::DepEax, 0, 0, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_moffs32_eax() {
  ...
  newUinst(Uinst::OpcodeEffaddr, 0, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, getMoffsAddress(), 4, Uinst::DepAux,
                 Uinst::DepEax, 0, 0, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_ir8_imm8() {
  ...
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepIr8, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_ir16_imm16() {
  ...
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepIr16, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_ir32_imm32() {
  ...
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepIr32, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_rm16_imm16() {
  ...
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepRm16, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_rm32_imm32() {
  ...
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepRm32, 0, 0, 0);
}
...
void Context::ExecuteInst_mov_rm16_sreg() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepSreg, 0, 0, Uinst::DepRm16, 0, 0, 0);
}

void Context::ExecuteInst_mov_rm32_sreg() { ExecuteInst_mov_rm16_sreg(); }
...
void Context::ExecuteInst_mov_sreg_rm16() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm16, 0, 0, Uinst::DepSreg, 0, 0, 0);
}

void Context::ExecuteInst_mov_sreg_rm32() { ExecuteInst_mov_sreg_rm16(); }

void Context::ExecuteInst_movsx_r16_rm8() {
  unsigned short value = (char)LoadRm8();
  StoreR16(value);

  newUinst(Uinst::OpcodeSign, Uinst::DepRm8, 0, 0, Uinst::DepR16, 0, 0, 0);
}
...
void Context::ExecuteInst_movsx_r32_rm8() {
  ...
  newUinst(Uinst::OpcodeSign, Uinst::DepRm8, 0, 0, Uinst::DepR32, 0, 0, 0);
}
...
void Context::ExecuteInst_movsx_r32_rm16() {
  ...
  newUinst(Uinst::OpcodeSign, Uinst::DepRm16, 0, 0, Uinst::DepR32, 0, 0, 0);
}
...
void Context::ExecuteInst_movzx_r16_rm8() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm8, 0, 0, Uinst::DepR16, 0, 0, 0);
}
...
void Context::ExecuteInst_movzx_r32_rm8() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm8, 0, 0, Uinst::DepR32, 0, 0, 0);
}
...
void Context::ExecuteInst_movzx_r32_rm16() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm16, 0, 0, Uinst::DepR32, 0, 0, 0);
}
...
void Context::ExecuteInst_mul_rm32() {
  ...
  newUinst(Uinst::OpcodeMult, Uinst::DepRm32, Uinst::DepEax, 0, Uinst::DepEdx,
           Uinst::DepEax, Uinst::DepOf, Uinst::DepCf);
}
...
void Context::ExecuteInst_not_rm8() {
  ...
  newUinst(Uinst::OpcodeNot, Uinst::DepRm8, 0, 0, Uinst::DepRm8, 0, 0, 0);
}
...
void Context::ExecuteInst_not_rm16() {
  ...
  newUinst(Uinst::OpcodeNot, Uinst::DepRm8, 0, 0, Uinst::DepRm16, 0, 0, 0);
}
...
void Context::ExecuteInst_not_rm32() {
  ...
  newUinst(Uinst::OpcodeNot, Uinst::DepRm8, 0, 0, Uinst::DepRm32, 0, 0, 0);
}
...
void Context::ExecuteInst_popf() {
  ...
  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEsp, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, regs.getEsp() - 4, 4, Uinst::DepAux, 0, 0,
                 Uinst::DepZps, Uinst::DepCf, Uinst::DepOf, 0);
  newUinst(Uinst::OpcodeAdd, Uinst::DepEsp, 0, 0, Uinst::DepEsp, 0, 0, 0);
}
...
void Context::ExecuteInst_prefetcht0_m8() {
  ...
  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEaseg, Uinst::DepEabas,
           Uinst::DepEaidx, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodePrefetch, eff_addr, 1, Uinst::DepAux, 0, 0, 0, 0,
                 0, 0);
}
...
void Context::ExecuteInst_push_rm32() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepEsp, 0, 0, Uinst::DepEsp, 0, 0, 0);
  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEsp, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, regs.getEsp(), 4, Uinst::DepAux,
                 Uinst::DepRm32, 0, 0, 0, 0, 0);
}
...
void Context::ExecuteInst_pushf() {
  ...
  newUinst(Uinst::OpcodeSub, Uinst::DepEsp, 0, 0, Uinst::DepEsp, 0, 0, 0);
  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEsp, 0, 0, Uinst::DepAux, 0, 0, 0);
  newUinst(Uinst::OpcodeMove, Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,
           Uinst::DepAux2, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeStore, regs.getEsp(), 4, Uinst::DepAux,
                 Uinst::DepAux2, 0, 0, 0, 0, 0);
}
...
void Context::ExecuteInst_rdtsc() {
  ...
  newUinst(Uinst::OpcodeMove, 0, 0, 0, Uinst::DepEax, Uinst::DepEdx, 0, 0);
}
...
void Context::ExecuteInst_ret() {
  ...
  // Call stack
  if (call_stack != nullptr) call_stack->Return(regs.getEip(), regs.getEsp());
  ...
  newMemoryUinst(Uinst::OpcodeLoad, regs.getEsp() - 4, 4, Uinst::DepAux, 0, 0,
                 Uinst::DepAux, 0, 0,
                 0);  // pop aux
  newUinst(Uinst::OpcodeAdd, Uinst::DepEsp, 0, 0, Uinst::DepEsp, 0, 0,
           0);                                                  // add esp, 4
  newUinst(Uinst::OpcodeRet, Uinst::DepAux, 0, 0, 0, 0, 0, 0);  // jmp aux
}

void Context::ExecuteInst_repz_ret() { ExecuteInst_ret(); }
...
void Context::ExecuteInst_ret_imm16() {
  ...
  // Micro-instructions
  newUinst(Uinst::OpcodeEffaddr, Uinst::DepEsp, 0, 0, Uinst::DepAux, 0, 0, 0);
  newMemoryUinst(Uinst::OpcodeLoad, regs.getEsp() - 4 - pop, 4, Uinst::DepAux,
                 0, 0, Uinst::DepAux, 0, 0,
                 0);  // pop aux
  newUinst(Uinst::OpcodeAdd, Uinst::DepEsp, 0, 0, Uinst::DepEsp, 0, 0,
           0);                                                  // add esp, 4
  newUinst(Uinst::OpcodeRet, Uinst::DepAux, 0, 0, 0, 0, 0, 0);  // jmp aux
...
void Context::ExecuteInst_sahf() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepEax, 0, 0, 0, Uinst::DepZps,
           Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_shld_rm16_r16_imm8() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm16, Uinst::DepR16, 0, Uinst::DepRm16,
           Uinst::DepZps, Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_shld_rm16_r16_cl() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm16, Uinst::DepR16, Uinst::DepEcx,
           Uinst::DepRm16, Uinst::DepZps, Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_shld_rm32_r32_imm8() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm32, Uinst::DepR32, 0, Uinst::DepRm32,
           Uinst::DepZps, Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_shld_rm32_r32_cl() {
  ...
  newUinst(Uinst::OpcodeShift, Uinst::DepRm32, Uinst::DepR32, Uinst::DepEcx,
           Uinst::DepRm32, Uinst::DepZps, Uinst::DepCf, Uinst::DepOf);
}
...
void Context::ExecuteInst_xadd_rm8_r8() {
  ...
  newUinst(Uinst::OpcodeAdd, Uinst::DepRm8, Uinst::DepR8, 0, Uinst::DepAux,
           Uinst::DepZps, Uinst::DepCf, Uinst::DepOf);
  newUinst(Uinst::OpcodeMove, Uinst::DepAux, 0, 0, Uinst::DepRm8, 0, 0, 0);
  newUinst(Uinst::OpcodeMove, Uinst::DepAux, 0, 0, Uinst::DepR8, 0, 0, 0);
}
...
void Context::ExecuteInst_xadd_rm32_r32() {
  ...
  newUinst(Uinst::OpcodeAdd, Uinst::DepRm32, Uinst::DepR32, 0, Uinst::DepAux,
           Uinst::DepZps, Uinst::DepCf, Uinst::DepOf);
  newUinst(Uinst::OpcodeMove, Uinst::DepAux, 0, 0, Uinst::DepRm32, 0, 0, 0);
  newUinst(Uinst::OpcodeMove, Uinst::DepAux, 0, 0, Uinst::DepR32, 0, 0, 0);
}
...
void Context::ExecuteInst_xchg_ir16_ax() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepIr16, Uinst::DepEax, 0, Uinst::DepIr16,
           Uinst::DepEax, 0, 0);
}
...
void Context::ExecuteInst_xchg_ir32_eax() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepIr32, Uinst::DepEax, 0, Uinst::DepIr32,
           Uinst::DepEax, 0, 0);
}
...
void Context::ExecuteInst_xchg_rm8_r8() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm8, Uinst::DepR8, 0, Uinst::DepRm8,
           Uinst::DepR8, 0, 0);
}
...
void Context::ExecuteInst_xchg_rm16_r16() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm16, Uinst::DepR16, 0, Uinst::DepRm16,
           Uinst::DepR16, 0, 0);
}
...
void Context::ExecuteInst_xchg_rm32_r32() {
  ...
  newUinst(Uinst::OpcodeMove, Uinst::DepRm32, Uinst::DepR32, 0, Uinst::DepRm32,
           Uinst::DepR32, 0, 0);
}
