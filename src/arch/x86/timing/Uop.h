...
class Uop {
 ...
 public:
  ...
  ///
  Uop(Thread* thread, Context* context, std::shared_ptr<Uinst> uinst);
  ...
  BranchPredictor::Prediction bimod_prediction =
  ...
  BranchPredictor::Prediction two_level_prediction =
      BranchPredictor::PredictionNotTaken;
  ...
  BranchPredictor::Prediction choice_prediction =
      BranchPredictor::PredictionNotTaken;
