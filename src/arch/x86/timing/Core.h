...
class Core {
 ...
 public:
  ...
  int getNumOccupiedIntegerRegisters() {
    return num_occupied_integer_registers;
  }

  /// Get the number of occupied physical float point registers
  int getNumOccupiedFloatingPointRegisters() {
    return num_occupied_floating_point_registers;
  }
  ...
  int getLoadStoreQueueOccupancy() const { return load_store_queue_occupancy; }
  ...
  long long getNumReorderBufferReads() const {
    return num_reorder_buffer_reads;
  }
  ...
  long long getNumReorderBufferWrites() const {
    return num_reorder_buffer_writes;
  }
  ...
  long long getNumInstructionQueueReads() const {
    return num_instruction_queue_reads;
  }
  ...
  long long getNumInstructionQueueWrites() const {
    return num_instruction_queue_writes;
  }
  ...
  long long getNumLoadStoreQueueReads() const {
    return num_load_store_queue_reads;
  }
  ...
  long long getNumLoadStoreQueueWrites() const {
    return num_load_store_queue_writes;
  }
