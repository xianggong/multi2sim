...
class Cache {
 public:
  ...
  enum WritePolicy { WriteInvalid, WriteBack, WriteThrough };
 ...
 public:
  /// Constructor
  Cache(const std::string& name, unsigned num_sets, unsigned num_ways,
  ...
  ///
  void DecodeAddress(unsigned address, unsigned& set_id, unsigned& tag,
  ...
  bool FindBlock(unsigned address, unsigned& set_id, unsigned& way_id,
  ...
  void setBlock(unsigned set_id, unsigned way_id, unsigned tag,
                BlockState state);
  ...
  ///
  void getBlock(unsigned set_id, unsigned way_id, unsigned& tag,
                BlockState& state) const;
