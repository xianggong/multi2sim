...
class System {
  ...
  Module* addModule(const std::string& name, Module::Type type, int num_ports,
                    int block_size, int data_latency) {
    assert(module_map.find(name) == module_map.end());
    modules.emplace_back(misc::new_unique<Module>(name, type, num_ports,
                                                  block_size, data_latency));
  ...
  void ConfigInsertModuleInInternalNetwork(misc::IniFile* ini_file,
                                           Module* module,
  ...
  void ConfigInsertModuleInExternalNetwork(misc::IniFile* ini_file,
                                           Module* module,
                                           const std::string& network_name,
                                           const std::string& network_node_name,
                                           net::Network*& network,
  ...
  Module* ConfigReadCache(misc::IniFile* ini_file, const std::string& section);

  Module* ConfigReadMainMemory(misc::IniFile* ini_file,
                               const std::string& section);

  void ConfigInvalidAddressRange(misc::IniFile* ini_file, Module* module);

  void ConfigReadModuleAddressRange(misc::IniFile* ini_file, Module* module,
                                    const std::string& section);

  void ConfigReadModules(misc::IniFile* ini_file);

  void ConfigCheckRouteToMainMemory(misc::IniFile* ini_file, Module* module,
