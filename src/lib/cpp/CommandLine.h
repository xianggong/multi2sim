...
class CommandLineOptionString : public CommandLineOption {
 ...
 public:
  /// Constructor
  CommandLineOptionString(const std::string& name, std::string* variable,
                          const std::string& help)
      : CommandLineOption(TypeString, name, 1, help), variable(variable) {}
...
class CommandLineOptionInt32 : public CommandLineOption {
 ...
 public:
  /// Constructor
  CommandLineOptionInt32(const std::string& name, int* variable,
                         const std::string& help)
      : CommandLineOption(TypeInt32, name, 1, help), variable(variable) {}
...
class CommandLineOptionInt64 : public CommandLineOption {
 ...
 public:
  /// Constructor
  CommandLineOptionInt64(const std::string& name, long long* variable,
                         const std::string& help)
      : CommandLineOption(TypeInt64, name, 1, help), variable(variable) {}
...
class CommandLineOptionDouble : public CommandLineOption {
 ...
 public:
  /// Constructor
  CommandLineOptionDouble(const std::string& name, double* variable,
                          const std::string& help)
      : CommandLineOption(TypeDouble, name, 1, help), variable(variable) {}
...
class CommandLineOptionEnum : public CommandLineOption {
 ...
 public:
  /// Constructor
  CommandLineOptionEnum(const std::string& name, int* variable,
...
class CommandLineOptionBool : public CommandLineOption {
 ...
 public:
  /// Constructor
  CommandLineOptionBool(const std::string& name, bool* variable,
                        const std::string& help)
      : CommandLineOption(TypeBool, name, 0, help), variable(variable) {}
...
class CommandLine {
 ...
 public:
  ...
  void Register(const std::string& name, bool& variable,
                const std::string& help) {
    Register(misc::new_unique<CommandLineOptionBool>(name, &variable, help));
  }
  ...
  void RegisterString(const std::string& name, std::string& variable,
                      const std::string& help) {
    Register(misc::new_unique<CommandLineOptionString>(name, &variable, help));
  }
  ...
  void RegisterInt32(const std::string& name, int& variable,
                     const std::string& help) {
    Register(misc::new_unique<CommandLineOptionInt32>(name, &variable, help));
  }
  ...
  void RegisterUInt32(const std::string& name, unsigned& variable,
                      const std::string& help) {
    Register(
        misc::new_unique<CommandLineOptionInt32>(name, (int*)&variable, help));
  }
  ...
  void RegisterInt64(const std::string& name, long long& variable,
                     const std::string& help) {
    Register(misc::new_unique<CommandLineOptionInt64>(name, &variable, help));
  }

  /// Same as RegisterString(), but taking a signed 32-bit integer as the
  /// type of the command-line option.
  void RegisterUInt64(const std::string& name, unsigned long long& variable,
                      const std::string& help) {
    Register(misc::new_unique<CommandLineOptionInt64>(
        name, (long long*)&variable, help));
  }

  /// Same as RegisterString(), but taking a double as the
  /// type of the command-line option.
  void RegisterDouble(const std::string& name, double& variable,
                      const std::string& help) {
    Register(misc::new_unique<CommandLineOptionDouble>(name, (double*)&variable,
                                                       help));
  }
  ...
  void RegisterEnum(const std::string& name, int& variable,
                    const StringMap& map, const std::string& help) {
    Register(
        misc::new_unique<CommandLineOptionEnum>(name, &variable, map, help));
  }
