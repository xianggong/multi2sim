...
class IniFile {
  ...
  static void ItemToSectionVar(const std::string& item, std::string& section,
                               std::string& var);
  ...
  bool InsertVariable(std::string section, std::string var, std::string value);
 ...
 public:
  ...
  friend std::ostream& operator<<(std::ostream& os, const IniFile& ini_file) {
    ini_file.Dump(os);
    return os;
  }
  ...
  /// file.
  std::vector<std::string>::iterator sections_end() { return sections.end(); }
  ...
  void WriteInt(const std::string& section, const std::string& var, int value);
  ...
  /// map.
  void WriteEnum(const std::string& section, const std::string& var, int value,
                 misc::StringMap& map);
  ...
  std::string ReadString(const std::string& section, const std::string& var,
                         const std::string& def = "");

  /// Read an integer variable
  int ReadInt(const std::string& section, const std::string& var, int def = 0);
