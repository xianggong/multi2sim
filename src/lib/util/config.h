...
void config_write_double(struct config_t* config, char* section, char* var,
                         double value);
void config_write_enum(struct config_t* config, char* section, char* var,
                       int value, char** map, int map_count);
void config_write_ptr(struct config_t* config, char* section, char* var,
                      void* value);

/* Read variables from a section.
 * If a section or variable does not exist, the default value in 'def' is
 * returned.
 * Sections and variables given in 'config_read_XXX' functions are automatically
 * added
