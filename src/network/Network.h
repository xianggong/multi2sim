...
class Network {
 ...
 public:
  ...
  void ParseConfiguration(misc::IniFile* ini_file, const std::string& section);
  ...
  ///
  bool CanSend(EndNode* source_node, EndNode* destination_node, int size,
  ...
  ///	scheduled).
  ///
  Message* Send(EndNode* source_node, EndNode* destination_node, int size,
  ...
  ///
  Message* TrySend(EndNode* source_node, EndNode* destination_node, int size,
                   esim::Event* receive_event = nullptr,
                   esim::Event* retry_event = nullptr);
  ...
  EndNode* addEndNode(int input_buffer_size, int output_buffer_size,
                      const std::string& name, void* user_data);

  /// Create a switch in the network
  Switch* addSwitch(int input_buffer_size, int output_buffer_size,
  ...
  Link* addLink(const std::string name, Node* source_node, Node* dest_node,
                int bandwidth, int source_buffer_size, int dest_buffer_size,
                int num_virtual_channels);

  /// Add a bidirectional link to the network
  void addBidirectionalLink(const std::string name, Node* source_node,
  ...
  Bus* addBus(const std::string name, int bandwith, int lanes);
