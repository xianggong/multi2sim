...
EndNode::EndNode(Network* network, int index, int input_buffer_size,
                 int output_buffer_size, const std::string& name,
                 void* user_data)
    : Node(network, index, input_buffer_size, output_buffer_size, name,
           user_data) {}
